def simple_get_request(path: str):
    event = {
        ...
        "headers": {
            ...
            "host": "gxn4ocnpcc2fg65qqfmkdrl4li0ohyvw.lambda-url.ap-southeast-1.on.aws",
            "x-forwarded-port": "443",
            "x-forwarded-for": "49.49.237.96", "accept-encoding": "gzip, deflate", "accept": "*/*",
